...
class MinesweeperAI():
    ...
    def update_knowledge(self):
        """
        Updates knowledge base by marking cells as safe or mines
        when possible.
        """
        for sentence in self.knowledge[:]:
...
class Sentence():
    ...
    def known_mines(self):
            ...
            If the count of mines equals the number of cells, all cells are mines.
            """
    ...
    def mark_mine(self, cell):
        ...
        a cell is known to be a mine. Removes the cell from the sentence
        and decreases the count of mines.
        """
    ...
    def mark_safe(self, cell):
        """
        Updates internal knowledge representation given the fact that
        a cell is known to be safe. Removes the cell from the sentence.
        """
        if cell in self.cells:
            self.cells.remove(cell)
